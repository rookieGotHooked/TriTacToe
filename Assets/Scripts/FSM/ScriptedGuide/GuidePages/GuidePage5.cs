...
public class GuidePage5 : BaseGuidePage<GuidePageEnum>
{
	private FSM_GuideManager _instance;
	private bool _isInit = false;
	public GuidePage5(GuidePageObjects objects, GuidePageEnum currentPageKey, GuidePageEnum nextPageKey, GuidePageEnum previousPageKey) :
	...
	async public override Task OnEnter()
	{
		...
		tweenHighlightSymbolTasks = new()
		{
			_instance.ScoreDisplayController.HighlighAppear(),
			_instance.ScoreDisplayController.MoveTextUp(1)
		};
